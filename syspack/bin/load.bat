...
%JAVACMD% %JAVA_OPTS% -Xms256m -Xmx2048m -classpath %CLASSPATH% -Dapp.name="load" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.storm.syspack.LoadApp %CMD_LINE_ARGS%
