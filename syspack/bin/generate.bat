...
%JAVACMD% %JAVA_OPTS% -Xms256m -Xmx2048m -classpath %CLASSPATH% -Dapp.name="generate" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.storm.syspack.GeneratorApp %CMD_LINE_ARGS%
